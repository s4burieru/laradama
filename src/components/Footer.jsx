...
export default function Footer() {
  return (
      <footer className="relative m-0 w-full overflow-hidden border-y border-[#292929] bg-[#111] text-[#e9e9e9] font-sans">
      <div className="mx-auto grid h-95 w-full max-w-375 grid-cols-[36%_27%_37%] box-border px-2 max-[640px]:h-auto max-[640px]:grid-cols-1 max-[640px]:px-0">
        <section className="min-w-0 p-[56px_0_10px_55px] max-[1024px]:pl-4 max-[640px]:border-[#303030] max-[640px]:p-[26px_24px_20px] max-[640px]:border-t-0">
          ...
          <div className="mt-3.25 h-px bg-[#303030]" />
          <ul className="mt-5 grid list-none gap-2.5 p-0 text-[16px] text-[#bdbdbd]">
            <li className="flex items-center gap-2.5"><MapPin className="h-4 w-4 stroke-[2.5]" /> Rizal, Philippines</li>
            <li className="flex items-center gap-2.5"><Phone className="h-4 w-4 stroke-[2.5]" /> +63 9763676567</li>
            <li className="flex items-center gap-2.5"><Mail className="h-4 w-4 stroke-[2.5]" /> name@email.com</li>
          </ul>
        </section>

        {/* Nav */}
        <nav className="min-w-0 border-l border-[#303030] pt-14 pb-7.75 max-[640px]:border-l-0 max-[640px]:border-t max-[640px]:border-[#303030] max-[640px]:p-6" aria-label="Footer navigation">
          <ul className="m-0 grid list-none gap-3.5 border-b border-[#303030] p-0 pb-7.75">
            {nav.map((item) => (
        ...
        {/* CTA */}
        <section className="relative z-1 flex min-w-0 flex-col overflow-hidden border-l border-[#303030] p-[56px_16px] pl-6.5 max-[640px]:border-l-0 max-[640px]:border-t max-[640px]:border-[#303030] max-[640px]:p-6">
          ...
          <div className="relative z-2 mt-auto grid h-16.25 grid-cols-[36%_27%_37%] items-center text-[12px] leading-[1.4] text-[#8e8e8e] max-[1100px]:h-auto max-[1100px]:grid-cols-1 max-[1100px]:gap-3 max-[1100px]:p-[18px_24px]">
            <p className="m-0 pl-13.75 text-[12px] max-[1100px]:pl-0">© 2026 laradama.ai</p>
            <div className="flex gap-2.5 pl-2.5 text-[12px] max-[1100px]:pl-0">
          ...
          <img className="pointer-events-none absolute -bottom-20 -right-7.5 z-0 h-90 w-90 object-cover opacity-20 saturate-[0.9]" src="/laradama-logo.png" alt="" aria-hidden="true" />
        </section>
      </div>
      </footer>
  );
