...
export default function Hero() {
  ...
  return (
    <>
      ...
      <div className="pointer-events-none absolute right-0 top-10 h-96 w-96 rounded-full bg-laradama-brand/20 blur-[100px]" />
      <div className="mx-auto grid max-w-295 grid-cols-1 items-center gap-14 px-8 py-24 xl:grid-cols-2">
        {/* Left copy */}
        <div>
